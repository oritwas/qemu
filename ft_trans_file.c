...
static const QEMUFileOps ft_trans_file_ops = {
    .put_buffer =     ft_trans_put_buffer,
    .get_buffer =     ft_trans_get_buffer,
    .close =          ft_trans_close,
    .rate_limit =     ft_trans_rate_limit,
                                  ...
                                  bool is_sender)
{
    ...
    s->file = qemu_fopen_ops(s, &ft_trans_file_ops);
